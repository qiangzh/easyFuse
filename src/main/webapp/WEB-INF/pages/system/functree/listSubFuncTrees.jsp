...
<div class="span15">	
	...
	<display:table id="funcTree" name="funcTrees" requestURI="" defaultsort="1" pagesize="10" 
		...
		<display:column property="code" titleKey="funcTree.code" sortable="true" escapeXml="true"/>
		<display:column property="name" titleKey="funcTree.name" sortable="true" autolink="true" media="html" />
